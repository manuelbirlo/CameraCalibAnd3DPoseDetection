...
#this will load the sample videos if no camera ID is given   --> changed by PG
input_stream1 = 'measurement_videos/02/camL_03.mp4'
input_stream2 = 'measurement_videos/02/camR_03.mp4'

#def get_input_stream1():
#        return input_stream1
